    ...
    <section className="w-full font-poppins overflow-hidden">
      ...
      <section className="px-[20px] md:px-[30px] bg-main_section lg:px-[50px] xl:px-[100px] lg:py-[80px]">
        <div className="flex justify-center items-center space-x-1 lg:space-x-3 p-4">
          {["All", "Exchange", "Self Deposit", "Investment site"].map(
            (category) => (
              <button
                key={category}
        ...
        <section className="pt-[50px] grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-[25px]">
          {filteredItems.map((data, i) => (
            <div
              key={i}
              className="p-[7px] rounded-[10px] group  bg-white overflow-hidden z-[1] "
            >
              ...
              <div className="p-[15px] font-rubik">
                {data.title.length > 60 ? (
                  <h2 className="text-[22px] mb-[15px] font-[600] font-bangla_font">
                ...
                <h2 className="text-[16px] font-[500] text-neutral-600 mb-[8px]">
                  Single License:${data.singleLicense}
                </h2>
                <h2 className="text-[16px] font-[500] text-neutral-600">
                ...
                <div className="flex justify-center items-center gap-[15px] mt-[15px]">
                  <button className="w-[50%] h-[50px] text-red-500 border-red-400 border-[2px] font-[500] text-[17px] hover:bg-red-400 hover:text-white transition-all duration-150">
                    Live Demo
                  </button>
                  <NavLink
                    ...
                    className="w-[50%]"
                  >
                    <button className="w-[100%] h-[50px] text-gray-500 border-gray-400 border-[2px] font-[500] text-[17px] hover:bg-gray-400 hover:text-white transition-all duration-150">
                      Details
                    </button>
                  </NavLink>
                </div>
