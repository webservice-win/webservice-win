...
const Pastorderpaymnet = () => {
  ...
  useEffect(() => {
    axios.get(`${base_url}/single-order-information/${id}`)
      .then((res) => {
        if (res.data.success) {
  ...
  const handlePayNow = async (e) => {
    ...
    try {
      ...
      console.log(trxId)
      await axios.post(`${base_url}/due-order`, {
          ...
          <div className="w-full md:w-1/2  shadow  p-[10px] bg-[#3D2BFB]">
            <div className='p-6 bg-[#010053]'>
              <h1 className='text-center text-white font-[500] text-[22px] p-[10px] bg-indigo-800'>Order Details</h1>
               <h1 className='text-[20px] mt-[10px] text-white font-[500] '>{product.product_name}</h1>
              <div className='flex justify-between items-center'>
               <h1 className='text-[20px] mt-[10px] text-white font-[500] '>{product.package_name}</h1>
               <h1 className='text-[20px] mt-[10px] text-white font-[500] '>${product.product_price}</h1>
              </div>
              <h1 className='text-[20px] text-white mt-[20px]'>Invoice ID:{id}</h1>
            </div>
          ...
          <div className="w-full md:w-1/2 p-[10px] bg-[#010053] ">
            ...
            <div className="border-t mt-4 pt-4">
              <div className="flex justify-between text-sm font-semibold">
                <span className='text-[18px] text-white'>Remain AMOUNT</span>
...
export default Pastorderpaymnet;