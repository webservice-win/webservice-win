          ...
          <div className="hero w-full flex justify-center items-center z-[1]">
            <div className="text-center w-[90%] lg:w-[90%]  font-noto-sans">
              <h1 className="text-[20px] lg:text-[40px] font-bold mb-[10px] text-white">
                আমাদের গ্রাহক ওরাকল টেকনোলজি সম্পর্কে কি বলেন কিছু গ্রাহক এর
                ভিডিও রিভিউ দেখুন ..
              </h1>
              <p className="text-[16px]  lg:text-[18px] text-neutral-200">
                আমরা বিগত ২০১৭ সাল থেকে বেটিং সাইট ডেভেলপমেন্ট করে আসছি আপনাদের
                সকল ভালোবাসায় আমাদের রিমোটলি সার্ভিস প্রদান করা প্রতিষ্ঠান আজ
                আপনাদের সবার কাছে পরিচিত এবং আস্তার যায়গা করে নিয়েছে আমাদের
                গ্রাহক রা আমাদের ভিডিও বার্তার মাধ্যমে আমাদের ইনিস্পায়ার করছেন
                আপনাদের সকল ভালোবাসায় আমরা আরও অনেক দুর এগিয়ে যেতে চাই । দেখুন
