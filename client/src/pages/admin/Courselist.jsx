...
const Courselist = () => {
  ...
  const delete_course = (id) => {
    ...
    if (confirm_box) {
      axios
        .delete(`${base_url}/admin/delete-course/${id}`, {
          headers: {
                  ...
                  <tbody>
                    {filteredCourses.map((data, index) => (
                      ...
                      >
                        ...
                        <th
                          scope="row"
                          className="px-6 py-4 text-[18px] font-[700] text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-200 dark:border-gray-700"
                        >
                          ${data.offline_price}
                        </th>
                        <th
