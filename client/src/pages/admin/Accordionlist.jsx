...
const Accordionlist = () => {
  ...
  const delete_course = (id) => {
    ...
    if (confirm_box) {
      axios
        .delete(`${base_url}/admin/delete-accordion/${id}`, {
          headers: {
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border-l border-r border-b border-gray-200 dark:border-gray-700">
                  ...
                  <tbody>
                    {filteredCourses.map((data, index) => (
                      <tr
                        key={index}
                        className="bg-white border-b font-[500] border-gray-200 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                      >
                        <th
                          scope="row"
                          className="px-6 py-2 text-[16px] font-[500] text-neutral-700 whitespace-nowrap dark:text-white border-r border-gray-200 dark:border-gray-700"
                        >
