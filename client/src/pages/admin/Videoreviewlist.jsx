...
const Videoreviewlist = () => {
  ...
  const delete_video_review = (id) => {
    ...
    if (confirm_box) {
      axios
        .delete(`${base_url}/admin/delete-video-review/${id}`, {
          headers: {
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-white uppercase bg-indigo-500 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                      <th
                        scope="col"
                        className="px-6 py-3 font-[500] text-nowrap text-[15px]"
                      >
                        Image
                      </th>
                      <th
                    ...
                    {video_reviews.map((data) => {
                      return (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                          ...
                          <td className="px-6 py-4">{data.video_link}</td>
