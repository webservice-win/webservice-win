...
const [members,set_member]=useState([]);
    ...
    member.title.toString().includes(searchQuery) ||
    member.description.toString().includes(searchQuery)
  );
      // ------------delete course-------------
            const delete_member=(id)=>{
      const confirm_box=confirm("Are you sure?");
       if(confirm_box){
       axios.delete(`${base_url}/admin/delete-achievement/${id}`, {
                headers: {
            ...
            <tbody>
              {filteredCourses.map((data, index) => (
                <tr key={index} className="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                 ...
                 {
                    data.description.length > 20 ?  <th scope="row" className="px-6 py-2 text-[16px]  font-[500] whitespace-nowrap dark:text-white border-r border-gray-200 dark:border-gray-700">
                    {data.description.slice(0,20)}...
                  </th>: <th scope="row" className="px-6 py-2 text-[16px]  font-[500] whitespace-nowrap dark:text-white border-r border-gray-200 dark:border-gray-700">
                    {data.description}
                  </th>
                 }
                  <th scope="row" className="px-6 py-2 text-[16px]  font-[500] whitespace-nowrap dark:text-white border-r border-gray-200 dark:border-gray-700">
