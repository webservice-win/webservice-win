...
const Addpayment = () => {
  ...
  const delete_category = (id) => {
    ...
    if (confirm_box) {
      axios
        .delete(`${base_url}/admin/delete-payment/${id}`, {
          headers: {
            Authorization: localStorage.getItem("token"),
          },
        })
        ...
        <section className="w-[100%] m-auto py-[20px] xl:py-[40px] px-[15px]">
          ...
          <section className=" pb-[20px] w-full  mt-[20px] rounded-[10px]">
            ...
            <form
              ...
              className="w-[100%] rounded-[5px]  p-[20px] border-[1px] border-[#eee] m-auto"
            >
              <h1 className="text-[20px] font-[600] mb-[15px]">
                Add Payment Proof
              </h1>
