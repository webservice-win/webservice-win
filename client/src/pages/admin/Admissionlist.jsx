...
const Admissionlist = () => {
  ...
  const get_admission = () => {
    axios
      .get(`${base_url}/admin/all-admission`, {
        headers: {
  ...
  const filteredCourses = admission.filter(
    (admission) =>
  ...
  const delete_admission = (id) => {
    ...
    if (confirm_box) {
      axios
        .delete(`${base_url}/admin/delete-admission/${id}`, {
          headers: {
            Authorization: localStorage.getItem("token"),
          },
        })
                  ...
                  <tbody>
                    {filteredCourses.map((data, index) => (
                      ...
                      >
                        <th
                          scope="row"
                          className="px-6 py-2 text-[16px] font-[500]  tracking-[1px] text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-200 dark:border-gray-700"
                        >
                          {data?.name}
                        </th>
                        <th
