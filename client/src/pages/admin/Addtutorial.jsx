...
const Addtutorial = () => {
  ...
  const [title,set_tilte]=useState("")
  ...
  const handleSubmit = async (e) => {
    ...
    Swal.fire({
      title: "Submitting...",
      html: "Please wait while your tutorial information is being submitted.",
      ...
      >
        ...
        <section className="w-[100%] m-auto py-[20px] xl:py-[40px] px-[15px]">
          ...
          <section className="pt-[15px] px-[20px] pb-[20px] w-full border-[1px] border-[#eee]  mt-[20px] rounded-[5px]">
            <div>
              <h2 className="text-[20px]  mb-[15px] lg:text-[20px] font-[600]">
                Add Tutorial
              </h2>
            </div>
            {/* -------------------form---------------------- */}
            <form onSubmit={handleSubmit}>
              ...
              <div className="w-full flex gap-[10px] lg:gap-[30px] mb-[10px]">
                <div className="w-[100%]">
                  ...
                  >
                    Tutorial URL <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    name="videoUrl"
              ...
              <div className="w-full flex gap-[10px] lg:gap-[30px] mb-[10px]">
                <div className="w-[100%]">
                  ...
                  <input
                    ...
                    name="videoUrl"
                    value={title}
                    onChange={(e)=>{set_tilte(e.target.value)}}
                    placeholder="Enter Video URL"
                    className="w-full mt-[8px] rounded-[5px] placeholder-gray-500 outline-brand_color text-[14px] h-[45px] border-[1px] border-[#eee] p-[15px]"
                  />
                </div>
