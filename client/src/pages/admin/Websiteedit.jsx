...
const Websiteedit = () => {
  ...
  const removeUnlimitedFeature = (index) => {
    const updatedUnlimitedFeatures = unlimitedFeatures.filter(
      (_, i) => i !== index
    );
  ...
  const removeBettingFeature = (index) => {
    const updatedBettingFeatures = bettingFeatures.filter(
      (_, i) => i !== index
    );
    ...
    if (
      ...
      try {
        const response = await axios.post(
          `${base_url}/admin/update-website/${id}`,
          formdata,
          {
            headers: {
            ...
            <form onSubmit={handleSubmit} className="pt-[15px] lg:pt-[20px]">
              ...
              <div className="relative w-full mb-[30px]">
                ...
                <label
                  ...
                  className="absolute bottom-2 right-2 bg-blue-600 text-white p-3 rounded-[5px] cursor-pointer hover:bg-blue-700"
                >
                  Select File
                </label>
                <input
