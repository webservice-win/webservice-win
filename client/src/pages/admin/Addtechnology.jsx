...
const Addtechnology = () => {
  ...
  const get_category = () => {
    axios
      .get(`${base_url}/admin/all-technology`, {
        headers: {
  ...
  const delete_category = (id) => {
    ...
    if (confirm_box) {
      axios
        .delete(`${base_url}/admin/delete-technology/${id}`, {
          headers: {
            Authorization: localStorage.getItem("token"),
          },
        })
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-white uppercase bg-[#6366F1] dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="px-6 py-4 border-r border-gray-200 dark:border-gray-700  text-[14px] lg:text-[16px] font-[600]"
                      >
                        Action
                      </th>
                    </tr>
