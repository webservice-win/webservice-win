...
const Details = () => {
  ...
  const get_oursite = () => {
    axios
      .get(`${base_url}/admin/single-website-details/${id}`)
      .then((res) => {
        if (res.data.success) {
    ...
    <section className="w-full overflow-hidden font-poppins">
        ...
        <div className="hero w-full relative font-rubik h-[30vh] lg:h-[45vh] flex justify-center gap-[100px] items-center px-[20px] lg:px-[100px] py-[20px] overflow-hidden ">
          ...
          <div className="absolute top-0 left-0 w-full h-[100%] overflow-hidden">
            <img
              ...
              src={`${base_url}/images/${oursite.banner2}`}
              alt=""
            />
          </div>
          <div className="hero w-full flex justify-center items-center z-[1]">
            <div className="w-full">
              <h1 className="text-[18px] text-left m-auto lg:text-[30px]  font-[600] font-rubik text-white">
                {oursite.title}
              </h1>
            </div>
          </div>
      ...
      <div className="w-full h-[50px] lg:h-[60px] flex border-t-[2px] border-b-[2px] border-white">
        ...
        <div className="w-[80%] lg:w-[90%] h-full  flex justify-center items-center bg-green-800 text-[16px] lg:text-[20px] text-white">
          <marquee className=" inline-block text-white">
            {oursite?.note}
          </marquee>
        </div>
      </div>
      ...
      <section className="px-[20px] bg-main_section md:px-[50px] lg:px-[100px] pb-[60px]">
          ...
          <div className="">
            ...
            <div className="grid xl:grid-cols-3 lg:grid-cols-2 gap-[30px] grid-cols-1">
              ...
              >
                ...
                <h2 className="text-[16px] border-b-[1px] border-white pb-[5px] font-bold mb-4 text-center">
                  Single License Script
                </h2>
                <h3 className="text-3xl font-extrabold mb-4 text-center text-[#fed330]">
                  ${oursite.singleLicense}
                </h3>
              ...
              >
                ...
                <h2 className="text-[16px] border-b-[1px] border-white pb-[5px] font-bold mb-4 text-center">
                  Unlimited License Script
                </h2>
                <h3 className="text-3xl font-extrabold mb-4 text-center text-[#fed330]">
                  ${oursite.unlimitedLicense}
                </h3>
                <ul className="space-y-2 text-sm text-center list-none">
              ...
              >
                ...
                <h2 className="text-[16px] border-b-[1px] border-white pb-[5px] font-bold mb-4 text-center">
                  Completed Betting Website
                </h2>
                <h3 className="text-3xl font-extrabold mb-4 text-center text-[#fed330]">
                  ${oursite.bettinglicense}
                </h3>
                <ul className="space-y-2 text-sm text-center list-none">
            ...
            <section>
              <div className="mt-[10px] lg:mt-[20px]  p-[3px] bg-white rounded-[10px]">
                <img
                  ...
                  src={`${base_url}/images/${oursite.banner3}`}
                  alt=""
                />
              </div>
            </section>
          ...
          <div className="bg-[#1B1464] border-[3px]  border-white rounded-[10px]  p-[15px] shadow-lg w-full lg:w-1/3">
            <div>
              <div className="flex flex-col">
                ...
                <div
                  className="relative cursor-pointer w-full bg-white p-[3px] rounded-[10px]"
                  onClick={togglePopup}
                >
                  {/* Thumbnail */}
                  <img
                ...
                <h1 className="text-[20px] text-white text-left mt-[15px]">
                  {oursite.tutorialtitle}
                </h1>
                {/* Video Popup */}
                {isOpen && (
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-4 lg:gap-8 mt-[20px] ">
          ...
          <div className=" lg:w-2/3 w-full p-[20px] bg-white border-[3px] border-indigo-700">
            <h2 className="text-[15px] font-[500] text-neutral-600">
              <span className="font-[600] text-btncolor1">
                Oracle Technology LLC{" "}
              </span>
              We have been successfully working on betting site development
              since 2018. We provide complete guidance and support to create a
              betting site. Many people who come to work with us talk about
              budget; sites are available in the market for very little money.
              Why do we spend so much? I tell them they should not lose their
              money after falling into the trap of less cash. Read this post
              carefully to see what is needed to create a betting site, and then
              you will understand why it costs so much. Then, you will consider
              where and how to create a betting site and do business.
            </h2>
          ...
          <div className=" w-full lg:w-1/3">
            <div className="bg-[#1B1464] mb-[20px] border-white border-[3px]">
              <img
                className="w-full h-full"
                src={`${base_url}/images/${oursite.banner4}`}
                alt=""
              />
            </div>
            <div className="bg-[#1B1464] mb-[20px] border-white border-[3px]">
              <img
                className="w-full h-full"
                src={`${base_url}/images/${oursite.banner5}`}
                alt=""
              />
            </div>
            <div className="bg-[#1B1464] mb-[20px] border-white border-[3px]">
              <img
                className="w-full h-full"
                src={`${base_url}/images/${oursite.banner6}`}
                alt=""
              />
            </div>
          </div>
        ...
        <section className="flex flex-wrap mt-[20px] lg:flex-nowrap gap-4 lg:gap-8">
          {video_reviews.length > 0 ? (
            <section className="w-full  h-auto  py-[20px] lg:py-[50px] ">
