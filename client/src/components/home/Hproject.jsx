...
const Hproject = () => {
  ...
  return (
    <>
      {courses.length > 0 ? (
        <section className="w-full  relative h-auto bg-gradient-to-r from-blue-500 to-purple-500 px-[20px] md:px-[30px] lg:px-[50px] xl:px-[100px] py-[30px] lg:py-[50px] ">
          {/* -----------------------bg1-------------- */}
    ...
    <div className="fixed top-0 z-[1000] font-poppins left-0 w-full h-full bg-[rgba(0,0,0,0.4)] bg-opacity-50 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg w-[90%] max-w-[600px] z-[100]">
        ...
        <div className="absolute top-0 right-0 p-4">
          ...
          {courses.length > 3 ? (
            <div className="flex w-full items-center justify-center mt-[50px] z-[10]">
              <button className="px-[30px] py-[12px] text-white bg-indigo-800 border-[2px] border-white font-poppins text-[16px]">
                Load more
              </button>
            </div>
          ) : (
