...
const Dashboradheader = () => {
  ...
  return (
    <header className='w-full font-poppins h-[9vh] sticky top-0 left-0 z-[10] shadow-sm xl:h-[9vh] px-[20px] md:px-[30px] py-[10px] flex bg-white justify-between  xl:justify-end items-center'>
